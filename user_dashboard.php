    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-body">
            <ul>
              <marquee direction="up" scrollamount="2"><li class="text-danger"><a>1. Please always wear mask and sentize your hands timely.</a></li>
              <li class="text-danger"><a>2. Always maintain social distance.</a></li>
              <li class="text-danger"><a>3. Give your valuable feedback to improve us.</a></li></marquee>
            </ul>
          </div>
        </div>
      </div>
